  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-16">
        <h2 className="text-4xl font-bold text-blue-100">PROJECTS</h2>
            ...
            <div className="p-6">
              ...
              <div className="mb-4">
                {project.tags.map((tag, index) => (
                  <span
                    key={index}
                    className="inline-block bg-[#36ac63] text-xs font-semibold text-white rounded-full px-2 py-1 mr-2 mb-2"
                  >
                    {tag}
                  </span>
                ))}
              ...
              <div className="lg:p-8 p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {selectedProject.tags.map((tag, index) => (
                    <span
                      key={index}
                      className="bg-[#53ab56] text-xs font-semibold text-white rounded-full px-2 py-1"
                    >
                      {tag}
                    </span>
                  ))}
