  ...
  return (
    <footer className="text-white py-8 px-[12vw] md:px-[7vw] lg:px-[20vw]">
      <div className="container mx-auto text-center">
        {/* Name / Logo */}
        <h2 className="text-xl font-semibold text-green-500 ">Palthya Swaroopa</h2>
        ...
        <div className="flex flex-wrap justify-center space-x-4 mt-6">
          {[
            ...
            { icon: <FaLinkedin />, link: "https://www.linkedin.com/in/palthya-swaroopa-8b0b40281/" },
            { icon: <FaGithub/>, link: "https://github.com/Swaroopapalthya" },
        ...
        <p className="text-sm text-green-400 mt-6">
          © 2025 Palthya Swaroopa. All rights reserved.
        </p>
      </div>
    </footer>
  );
